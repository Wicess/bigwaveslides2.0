...
async function main() {
  ...
  const out: string[] = [
    ...
    `# method. You are not going to submit ${all.length} URLs by hand and you do`,
    "# not",
    "# need to. Once Google crawls the pages at the top and finds real content,",
    "# it follows your internal links to the rest on its own. What actually",
    "# raises crawl budget is a Google Business Profile and the first real",
    "# backlinks. Everything below the product sections is reference, not a",
    "# task list.",
    "#",
